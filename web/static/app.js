...
const I18N = {
  fr: {
    ...
    guideGitHubSteps: [
      ...
      "Garde M2 AMIS, la période 2026-09-21 → 2027-10-31 et includeAllEvents à true dans calendar-config.json.",
  ...
  en: {
    ...
    guideGitHubSteps: [
      ...
      "Keep M2 AMIS, the 2026-09-21 → 2027-10-31 range, and includeAllEvents set to true in calendar-config.json.",
